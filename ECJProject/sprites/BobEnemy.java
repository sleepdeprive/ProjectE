...
public class BobEnemy implements DisplayableSprite{
    ...
    private String filename = "res/Enemies/Bob.L.PNG";
    ...
    public BobEnemy(double centerX, double centerY) {
    ...
    public Image getImage() {
        ...
        filename = "res/Enemies/Bob." + direction + ".png";
    ...
    private int checkSight(ArrayList<DisplayableSprite> sprites, double deltaX, double deltaY) {
        ...
        for (DisplayableSprite sprite : sprites) {
            if (sprite instanceof PlayerSprite || sprite instanceof BloccSprite || sprite instanceof AdamEnemy  ||  (sprite instanceof BobEnemy && sprite != this)){
